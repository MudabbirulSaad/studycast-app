...
void main() {
  test(
    'submits, lists, controls, inspects jobs, and gets queue status',
    () async {
      ...
      expect(
        await service.submitJob(projectId: 'project-1', options: options),
        same(job),
      );
      expect(
      ...
      expect(
        (await service.cancelJob('job-1')).status,
